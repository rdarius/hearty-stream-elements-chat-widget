...
function addMessage(name, reply, badge, badges, message, isEmote, isAction, userId, msgId, pn) {
  ...
  if (mentions) {
    for (var i = 0; i < mentions.length; i++) {
      message = message.replace(mentions[i], `<p style="color: ${colorSettings.messageMentionedUsernameColor}">${mentions[i]}</p>`)
    }
  }
                ...
                <div class="regular">
                    <svg width="14" height="27" viewBox="0 0 14 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            fill="${colorSettings.cornerPieceUnderBadgeColor}" />
                    </svg>
                </div>
                ...
                <div class="top-border">
                    <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path class="${broadcasterClass}"
                            ...
                            stroke="${colorSettings.nonStreamerHeartNextToUsernameColor}" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    ...
                    <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path class="${broadcasterFill}"
                            ...
                            fill="${colorSettings.nonStreamerHeartTopLeftColor}" />
                    </svg>
            ...
            <div ${broadcasterBorder} class="message-box">
                ...
                <div class="message-box__top-right">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path class="${broadcasterClass}" d="M2 2C10.8366 2 18 9.16344 18 18" stroke="${colorSettings.nonStreamerTopRightCornerColor}" stroke-width="4"
                ...
                <div class="message-box__bottom-right">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path class="${broadcasterClass}" d="M18 2C18 10.8366 10.8366 18 2 18" stroke="${colorSettings.nonStreamerBottomRightCornerColor}" stroke-width="4"
                            stroke-linecap="round" />
                    </svg>
                </div>
                ...
                <div class="heart">
                    <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M9.35634 13.2437L14.4188 8.18121C15.6626 6.93121 15.8438 4.88746 14.6688 3.58121C14.3742 3.25203 14.0155 2.98639 13.6146 2.80052C13.2138 2.61464 12.7793 2.51244 12.3377 2.50016C11.8961 2.48787 11.4566 2.56576 11.046 2.72907C10.6355 2.89238 10.2626 3.13767 9.95009 3.44996L9.00009 4.40621L8.18134 3.58121C6.93134 2.33746 4.88759 2.15621 3.58134 3.33121C3.25215 3.62589 2.98651 3.98459 2.80064 4.3854C2.61476 4.78621 2.51256 5.22071 2.50028 5.66235C2.488 6.10398 2.56589 6.54349 2.72919 6.95401C2.8925 7.36453 3.13779 7.73744 3.45009 8.04996L8.64384 13.2437C8.73863 13.3376 8.86666 13.3903 9.00009 13.3903C9.13351 13.3903 9.26154 13.3376 9.35634 13.2437Z"
                            stroke="${colorSettings.heartInChatBubbleOnTheRightColor}" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </div>
                ...
                <div class="bottom-border">
                    <svg id="corner" width="20" height="20" viewBox="0 0 20 20" fill="none"
                        ...
                        <path class="${broadcasterClass}" d="M18 18C9.16344 18 2 10.8366 2 2" stroke="${colorSettings.nonStreamerBottomLeftCornerColor}" stroke-width="4"
                            stroke-linecap="round" />
                    </svg>
                    ...
                    <svg id="heart" width="18" height="16" viewBox="0 0 18 16" fill="none"
                        ...
                        <path class="${broadcasterFill}"
                            d="M16.5469 2.05466C16.1233 1.57925 15.6066 1.19594 15.0287 0.928502C14.4508 0.661066 13.8241 0.515208 13.1876 0.499975C12.5515 0.486034 11.9193 0.600631 11.3286 0.8369C10.7379 1.07317 10.201 1.42625 9.75006 1.87498L9.00006 2.61716L8.41413 2.03904C6.59381 0.210913 3.62506 0.0546631 1.80475 1.7031C1.33102 2.12808 0.948952 2.64522 0.681907 3.2229C0.414862 3.80058 0.268454 4.42666 0.251635 5.06285C0.234816 5.69905 0.347939 6.33199 0.584089 6.92297C0.820238 7.51396 1.17445 8.05056 1.62506 8.49998L8.11725 14.9922C8.23276 15.1089 8.37025 15.2015 8.52178 15.2647C8.67332 15.3279 8.83588 15.3605 9.00006 15.3605C9.16425 15.3605 9.32681 15.3279 9.47834 15.2647C9.62987 15.2015 9.76737 15.1089 9.88288 14.9922L16.211 8.66404C18.0391 6.84373 18.1876 3.87498 16.5469 2.05466Z"
                            fill="${colorSettings.nonStreamerHeartBottomLeftColor}" />
                    </svg>
    ...
    <div class="message-row" id="msg-${totalMsg}">
        ...
        <div class="alert-borders">
            ...
            <div class="alert-wrap__top-right">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2 2C10.8366 2 18 9.16344 18 18" stroke="${colorSettings.eventBorderTopRightCornerColor}" stroke-width="4"
                        stroke-linecap="round" />
                </svg>
            </div>
            ...
            <div class="alert-wrap__top-left">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2 18C2 9.16344 9.16344 2 18 2" stroke="${colorSettings.eventBorderTopLeftCornerColor}" stroke-width="4" stroke-linecap="round" />
                </svg>
            </div>

            <div class="alert-wrap__bottom-right">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M18 2C18 10.8366 10.8366 18 2 18" stroke="${colorSettings.eventBorderBottomRightCornerColor}" stroke-width="4"
                        stroke-linecap="round" />
                </svg>
            </div>
            ...
            <div class="alert-wrap__bottom-left">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M18 18C9.16344 18 2 10.8366 2 2" stroke="${colorSettings.eventBorderBottomLeftCornerColor}" stroke-width="4"
                        stroke-linecap="round" />
                </svg>
            </div>
            ...
            <div class="alert-top-border">
                ...
                <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M9.35634 13.2437L14.4188 8.18121C15.6626 6.93121 15.8438 4.88746 14.6688 3.58121C14.3742 3.25203 14.0155 2.98639 13.6146 2.80052C13.2138 2.61464 12.7793 2.51244 12.3377 2.50016C11.8961 2.48787 11.4566 2.56576 11.046 2.72907C10.6355 2.89238 10.2626 3.13767 9.95009 3.44996L9.00009 4.40621L8.18134 3.58121C6.93134 2.33746 4.88759 2.15621 3.58134 3.33121C3.25215 3.62589 2.98651 3.98459 2.80064 4.3854C2.61476 4.78621 2.51256 5.22071 2.50028 5.66235C2.488 6.10398 2.56589 6.54349 2.72919 6.95401C2.8925 7.36453 3.13779 7.73744 3.45009 8.04996L8.64384 13.2437C8.73863 13.3376 8.86666 13.3903 9.00009 13.3903C9.13351 13.3903 9.26154 13.3376 9.35634 13.2437Z"
                        stroke="${colorSettings.eventTopLeftHeartColor}" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                ...
                <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M16.5469 2.05466C16.1233 1.57925 15.6066 1.19594 15.0287 0.928502C14.4508 0.661066 13.8241 0.515208 13.1876 0.499975C12.5515 0.486034 11.9193 0.600631 11.3286 0.8369C10.7379 1.07317 10.201 1.42625 9.75006 1.87498L9.00006 2.61716L8.41413 2.03904C6.59381 0.210913 3.62506 0.0546631 1.80475 1.7031C1.33102 2.12808 0.948952 2.64522 0.681907 3.2229C0.414862 3.80058 0.268454 4.42666 0.251635 5.06285C0.234816 5.69905 0.347939 6.33199 0.584089 6.92297C0.820238 7.51396 1.17445 8.05056 1.62506 8.49998L8.11725 14.9922C8.23276 15.1089 8.37025 15.2015 8.52178 15.2647C8.67332 15.3279 8.83588 15.3605 9.00006 15.3605C9.16425 15.3605 9.32681 15.3279 9.47834 15.2647C9.62987 15.2015 9.76737 15.1089 9.88288 14.9922L16.211 8.66404C18.0391 6.84373 18.1876 3.87498 16.5469 2.05466Z"
                        fill="${colorSettings.eventTopRightHeartColor}" />
                </svg>
            ...
            <div class="alert-bottom-border">
                ...
                <svg id="heart" width="18" height="16" viewBox="0 0 18 16" fill="none"
                    ...
                    <path
                        d="M9.35634 13.2437L14.4188 8.18121C15.6626 6.93121 15.8438 4.88746 14.6688 3.58121C14.3742 3.25203 14.0155 2.98639 13.6146 2.80052C13.2138 2.61464 12.7793 2.51244 12.3377 2.50016C11.8961 2.48787 11.4566 2.56576 11.046 2.72907C10.6355 2.89238 10.2626 3.13767 9.95009 3.44996L9.00009 4.40621L8.18134 3.58121C6.93134 2.33746 4.88759 2.15621 3.58134 3.33121C3.25215 3.62589 2.98651 3.98459 2.80064 4.3854C2.61476 4.78621 2.51256 5.22071 2.50028 5.66235C2.488 6.10398 2.56589 6.54349 2.72919 6.95401C2.8925 7.36453 3.13779 7.73744 3.45009 8.04996L8.64384 13.2437C8.73863 13.3376 8.86666 13.3903 9.00009 13.3903C9.13351 13.3903 9.26154 13.3376 9.35634 13.2437Z"
                        stroke="${colorSettings.eventBottomHeartColor}" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            ...
            <div class="alert-left-border">
                ...
                <svg id="heart" width="18" height="16" viewBox="0 0 18 16" fill="none"
                    ...
                    <path
                        d="M9.35634 13.2437L14.4188 8.18121C15.6626 6.93121 15.8438 4.88746 14.6688 3.58121C14.3742 3.25203 14.0155 2.98639 13.6146 2.80052C13.2138 2.61464 12.7793 2.51244 12.3377 2.50016C11.8961 2.48787 11.4566 2.56576 11.046 2.72907C10.6355 2.89238 10.2626 3.13767 9.95009 3.44996L9.00009 4.40621L8.18134 3.58121C6.93134 2.33746 4.88759 2.15621 3.58134 3.33121C3.25215 3.62589 2.98651 3.98459 2.80064 4.3854C2.61476 4.78621 2.51256 5.22071 2.50028 5.66235C2.488 6.10398 2.56589 6.54349 2.72919 6.95401C2.8925 7.36453 3.13779 7.73744 3.45009 8.04996L8.64384 13.2437C8.73863 13.3376 8.86666 13.3903 9.00009 13.3903C9.13351 13.3903 9.26154 13.3376 9.35634 13.2437Z"
                        stroke="${colorSettings.eventLeftHeartColor}" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
        ...
        <div class="alert-wrap">
                    ...
                    <g opacity="1">
                        ...
                        <g mask="url(#mask0_83_171)">
                            ...
                            <path
                                ...
                                stroke="${colorSettings.eventBackgroundLeftEnvelopeOuterBorderColor}" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M88.8807 57.1398L48.2284 96.1522" stroke="${colorSettings.eventBackgroundLeftEnvelopeBottomLeftInsideLineColor}" stroke-width="4"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M160.185 79.2674L109.835 53.9796" stroke="${colorSettings.eventBackgroundLeftEnvelopeBottomRightInsideLineColor}" stroke-width="4"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M151.777 13.3645L109.835 53.9796L88.8808 57.1399L36.8265 30.7008"
                                stroke="${colorSettings.eventBackgroundLeftEnvelopeInsideTopLinesColor}" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                            <path opacity="0.2"
                                d="M381.454 60.6293L307.707 104.525L276.662 101.95L211.154 46.5041L301.013 -3.19986L381.454 60.6293Z"
                                fill="${colorSettings.eventBackgroundRightEnvelopeInsidesColor}" />
                            <path
                                ...
                                stroke="${colorSettings.eventBackgroundRightEnvelopeOuterBorderColor}" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M276.662 101.95L205.301 143.989" stroke="${colorSettings.eventBackgroundRightEnvelopeBottomLeftInsideLineColor}" stroke-width="4"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M371.166 157.747L307.706 104.525" stroke="${colorSettings.eventBackgroundRightEnvelopeBottomRightInsideLineColor}" stroke-width="4"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M381.454 60.6292L307.706 104.525L276.662 101.95L211.154 46.504"
                                stroke="${colorSettings.eventBackgroundRightEnvelopeInsideTopLinesColor}" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                            <path
                                ...
                                stroke="${colorSettings.unknown_1}" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                            <path
                                ...
                                stroke="${colorSettings.unknown_2}" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                            <path
                                ...
                                stroke="${colorSettings.eventBackgroundLeftHeartColor}" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                        </g>
                    </g>
                    <defs>
            ...
            <div class="left-detail">
                <svg width="22" height="30" viewBox="0 0 22 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14.154 28L20 25.2201M2 15L18.9089 15M14.1538 2L19.9998 4.77995" stroke="${colorSettings.eventBackgroundLeftWhiskersColor}"
            ...
            <div class="right-detail">
                <svg width="22" height="30" viewBox="0 0 22 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7.84598 28L2 25.2201M20 15L3.09107 15M7.84621 2L2.00023 4.77995" stroke="${colorSettings.eventBackgroundRightWhiskersColor}"
                        stroke-width="4" stroke-linecap="round" />
                </svg>
            </div>
        ...
        <div class="header">
            <div class="heart-bubble">
                <svg width="13" height="11" viewBox="0 0 13 11" fill="none"
                    ...
                    <path
                        d="M11.7829 1.33822C11.4863 1.00543 11.1246 0.737114 10.7201 0.549909C10.3156 0.362704 9.8769 0.260603 9.4313 0.24994C8.98608 0.240181 8.54348 0.320399 8.13001 0.485787C7.71654 0.651175 7.34071 0.898329 7.02505 1.21244L6.50004 1.73197L6.08989 1.32728C4.81567 0.0475964 2.73755 -0.0617786 1.46333 1.09213C1.13172 1.38961 0.864266 1.75161 0.677335 2.15599C0.490403 2.56036 0.387917 2.99862 0.376144 3.44395C0.364371 3.88929 0.443558 4.33235 0.608862 4.74604C0.774167 5.15973 1.02211 5.53535 1.33755 5.84994L5.88208 10.3945C5.96293 10.4762 6.05918 10.541 6.16525 10.5852C6.27132 10.6295 6.38511 10.6523 6.50004 10.6523C6.61498 10.6523 6.72877 10.6295 6.83484 10.5852C6.94091 10.541 7.03716 10.4762 7.11801 10.3945L11.5477 5.96478C12.8274 4.69057 12.9313 2.61244 11.7829 1.33822Z"
                        fill="${colorSettings.eventBackgroundSubscribeHeartLeftColor}" />
                </svg>
            </div>
            <div class="chevron">
                <svg width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3.5 1.99976L6 4.49976L3.5 6.99976" stroke="${colorSettings.eventBackgroundSubscribeHeartRightColor}" stroke-width="4"
                        stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            </div>
        ...
        <div class="header">
            <div class="heart-bubble">
                <svg width="13" height="11" viewBox="0 0 13 11" fill="none"
                    ...
                    <path
                        d="M11.7829 1.33822C11.4863 1.00543 11.1246 0.737114 10.7201 0.549909C10.3156 0.362704 9.8769 0.260603 9.4313 0.24994C8.98608 0.240181 8.54348 0.320399 8.13001 0.485787C7.71654 0.651175 7.34071 0.898329 7.02505 1.21244L6.50004 1.73197L6.08989 1.32728C4.81567 0.0475964 2.73755 -0.0617786 1.46333 1.09213C1.13172 1.38961 0.864266 1.75161 0.677335 2.15599C0.490403 2.56036 0.387917 2.99862 0.376144 3.44395C0.364371 3.88929 0.443558 4.33235 0.608862 4.74604C0.774167 5.15973 1.02211 5.53535 1.33755 5.84994L5.88208 10.3945C5.96293 10.4762 6.05918 10.541 6.16525 10.5852C6.27132 10.6295 6.38511 10.6523 6.50004 10.6523C6.61498 10.6523 6.72877 10.6295 6.83484 10.5852C6.94091 10.541 7.03716 10.4762 7.11801 10.3945L11.5477 5.96478C12.8274 4.69057 12.9313 2.61244 11.7829 1.33822Z"
                        fill="${colorSettings.eventBackgroundReSubscribeHeartLeftColor}" />
                </svg>
            </div>
            <div class="chevron">
                <svg width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3.5 1.99976L6 4.49976L3.5 6.99976" stroke="${colorSettings.eventBackgroundReSubscribeHeartRightColor}" stroke-width="4"
                        stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            </div>
        ...
        <div class="header">
            <div class="heart-bubble">
                <svg width="13" height="11" viewBox="0 0 13 11" fill="none"
                    ...
                    <path
                        d="M11.7829 1.33822C11.4863 1.00543 11.1246 0.737114 10.7201 0.549909C10.3156 0.362704 9.8769 0.260603 9.4313 0.24994C8.98608 0.240181 8.54348 0.320399 8.13001 0.485787C7.71654 0.651175 7.34071 0.898329 7.02505 1.21244L6.50004 1.73197L6.08989 1.32728C4.81567 0.0475964 2.73755 -0.0617786 1.46333 1.09213C1.13172 1.38961 0.864266 1.75161 0.677335 2.15599C0.490403 2.56036 0.387917 2.99862 0.376144 3.44395C0.364371 3.88929 0.443558 4.33235 0.608862 4.74604C0.774167 5.15973 1.02211 5.53535 1.33755 5.84994L5.88208 10.3945C5.96293 10.4762 6.05918 10.541 6.16525 10.5852C6.27132 10.6295 6.38511 10.6523 6.50004 10.6523C6.61498 10.6523 6.72877 10.6295 6.83484 10.5852C6.94091 10.541 7.03716 10.4762 7.11801 10.3945L11.5477 5.96478C12.8274 4.69057 12.9313 2.61244 11.7829 1.33822Z"
                        fill="${colorSettings.eventBackgroundGiftManyHeartLeftColor}" />
                </svg>
            </div>
            <div class="chevron">
                <svg width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3.5 1.99976L6 4.49976L3.5 6.99976" stroke="${colorSettings.eventBackgroundGiftManyHeartRightColor}" stroke-width="4"
                        stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            </div>
        ...
        <div class="header">
            <div class="heart-bubble">
                <svg width="13" height="11" viewBox="0 0 13 11" fill="none"
                    ...
                    <path
                        d="M11.7829 1.33822C11.4863 1.00543 11.1246 0.737114 10.7201 0.549909C10.3156 0.362704 9.8769 0.260603 9.4313 0.24994C8.98608 0.240181 8.54348 0.320399 8.13001 0.485787C7.71654 0.651175 7.34071 0.898329 7.02505 1.21244L6.50004 1.73197L6.08989 1.32728C4.81567 0.0475964 2.73755 -0.0617786 1.46333 1.09213C1.13172 1.38961 0.864266 1.75161 0.677335 2.15599C0.490403 2.56036 0.387917 2.99862 0.376144 3.44395C0.364371 3.88929 0.443558 4.33235 0.608862 4.74604C0.774167 5.15973 1.02211 5.53535 1.33755 5.84994L5.88208 10.3945C5.96293 10.4762 6.05918 10.541 6.16525 10.5852C6.27132 10.6295 6.38511 10.6523 6.50004 10.6523C6.61498 10.6523 6.72877 10.6295 6.83484 10.5852C6.94091 10.541 7.03716 10.4762 7.11801 10.3945L11.5477 5.96478C12.8274 4.69057 12.9313 2.61244 11.7829 1.33822Z"
                        fill="${colorSettings.eventBackgroundGiftOneHeartLeftColor}" />
                </svg>
            </div>
            <div class="chevron">
                <svg width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3.5 1.99976L6 4.49976L3.5 6.99976" stroke="${colorSettings.eventBackgroundGiftOneHeartRightColor}" stroke-width="4"
                        stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            </div>
        ...
        <div class="header">
            <div class="heart-bubble">
                <svg width="13" height="11" viewBox="0 0 13 11" fill="none"
                    ...
                    <path
                        d="M11.7829 1.33822C11.4863 1.00543 11.1246 0.737114 10.7201 0.549909C10.3156 0.362704 9.8769 0.260603 9.4313 0.24994C8.98608 0.240181 8.54348 0.320399 8.13001 0.485787C7.71654 0.651175 7.34071 0.898329 7.02505 1.21244L6.50004 1.73197L6.08989 1.32728C4.81567 0.0475964 2.73755 -0.0617786 1.46333 1.09213C1.13172 1.38961 0.864266 1.75161 0.677335 2.15599C0.490403 2.56036 0.387917 2.99862 0.376144 3.44395C0.364371 3.88929 0.443558 4.33235 0.608862 4.74604C0.774167 5.15973 1.02211 5.53535 1.33755 5.84994L5.88208 10.3945C5.96293 10.4762 6.05918 10.541 6.16525 10.5852C6.27132 10.6295 6.38511 10.6523 6.50004 10.6523C6.61498 10.6523 6.72877 10.6295 6.83484 10.5852C6.94091 10.541 7.03716 10.4762 7.11801 10.3945L11.5477 5.96478C12.8274 4.69057 12.9313 2.61244 11.7829 1.33822Z"
                        fill="${colorSettings.eventBackgroundCheerHeartLeftColor}" />
                </svg>
            </div>
            <div class="chevron">
                <svg width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3.5 1.99976L6 4.49976L3.5 6.99976" stroke="${colorSettings.eventBackgroundCheerHeartRightColor}" stroke-width="4"
                        stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            </div>
        ...
        <div class="header">
            <div class="heart-bubble">
                <svg width="13" height="11" viewBox="0 0 13 11" fill="none"
                    ...
                    <path
                        d="M11.7829 1.33822C11.4863 1.00543 11.1246 0.737114 10.7201 0.549909C10.3156 0.362704 9.8769 0.260603 9.4313 0.24994C8.98608 0.240181 8.54348 0.320399 8.13001 0.485787C7.71654 0.651175 7.34071 0.898329 7.02505 1.21244L6.50004 1.73197L6.08989 1.32728C4.81567 0.0475964 2.73755 -0.0617786 1.46333 1.09213C1.13172 1.38961 0.864266 1.75161 0.677335 2.15599C0.490403 2.56036 0.387917 2.99862 0.376144 3.44395C0.364371 3.88929 0.443558 4.33235 0.608862 4.74604C0.774167 5.15973 1.02211 5.53535 1.33755 5.84994L5.88208 10.3945C5.96293 10.4762 6.05918 10.541 6.16525 10.5852C6.27132 10.6295 6.38511 10.6523 6.50004 10.6523C6.61498 10.6523 6.72877 10.6295 6.83484 10.5852C6.94091 10.541 7.03716 10.4762 7.11801 10.3945L11.5477 5.96478C12.8274 4.69057 12.9313 2.61244 11.7829 1.33822Z"
                        fill="${colorSettings.eventBackgroundDonationHeartLeftColor}" />
                </svg>
            </div>
            <div class="chevron">
                <svg width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3.5 1.99976L6 4.49976L3.5 6.99976" stroke="${colorSettings.eventBackgroundDonationHeartRightColor}" stroke-width="4"
                        stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            </div>
